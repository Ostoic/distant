...
namespace distant::memory
{
	...
	>
	address<AddressT> 
		virtual_malloc(process<AccessRights>& process, std::size_t n);
	...
	template <
		...
		process_rights AccessRights = process_rights::all_access
	>
	virtual_ptr<T, AddressT, AccessRights> 
		virtual_malloc(process<AccessRights>& process, std::size_t n = sizeof_asserted_v<T>);
